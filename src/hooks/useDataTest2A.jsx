...
const useDataTest = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const trimmedNacinoalidad = nacionalidad.trim();
    ...
    if (!trimmedCancion) {
      setError("El cancion es obligatorio");
      return;
    }

    if (!trimmedNacinoalidad) {
      setError("El nacionalidad es obligatorio");
      return;
    }
    ...
    try {
      ...
      const payload = {
        ...
        nacionalidad: trimmedNacinoalidad
      };
